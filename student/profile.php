                        ...
                        <div>
                            <div class="row">
                                ...
                                <div class="col-lg-2 mt-2">
                                    ...
                                    <input type="text" class="form-control black3 fs-5 shadow-elevation-dark-1 rounded-5 py-2 px-3" placeholder="<?php if(isset($_SESSION["gender"])) echo $_SESSION["gender"]; ?>" name="birthdate" id="birthdate" readonly>
                                </div>
                                <div class="col-lg-2 mt-2">
