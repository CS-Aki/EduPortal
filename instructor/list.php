...
<head>
    ...
    <?php require('inc/links.php'); include("includes/view-list.php");?>
</head>
<body>
                    ...
                    <div class="mt-2" id="professor-container">
                        ...
                        <div class="ms-3">
                            <div class="d-flex align-items-center mb-3 mt-3" id="professor">
                                 <img src="<?php if(isset($_SESSION["profile"])){ echo "../profiles/".$_SESSION["profile"]; } else{ echo "../profiles/profile.png"; }  ?>" style="width: 40px;" class="rounded-5 me-3"></span>
