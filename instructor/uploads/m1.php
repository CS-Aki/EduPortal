                    ...
                    <div class="modal-body">
                            ...
                            <div class="row px-2">
                                ...
                                <div class="col-lg-3 col-sm-6 mb-2">
                                    <input type="date" class="form-control black3 shadow-elevation-light-3 container-fluid border-0 w-100" value="<?php echo $postDetails[0]["title"]; ?>" name="post_title" id="postTitle">
                                </div>
                                <div class="col-lg-3 col-sm-6 mb-2">
                                    <input type="time" class="form-control black3 shadow-elevation-light-3 container-fluid border-0 w-100" value="<?php echo $postDetails[0]["title"]; ?>" name="post_title" id="postTitle">
                                </div>
                                ...
                                <div class="col-lg-12 mb-2">
                                    ...
                                    <div class="w-100" id="material-download">
                                        ...
                                        <?php 
                                            echo '
                                                <a href="" class="btn bordergreen shadow-elevation-dark-1 rounded-4 white-btn p-2 col-lg-4 col-md-12 col-sm-12 mb-1">
                                            ...
                                            if($files != null){
                                                for($i = 0 ; $i < count($files); $i++){
                                                    echo '
                                                    <a href="" class="btn bg-body-tertiary shadow-elevation-dark-1 rounded-4 white-btn p-2 col-lg-4 col-md-12 col-sm-12 mb-1">
