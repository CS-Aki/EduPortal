...
$client->setRedirectUri('https://eduportal.aki-dev.online/instructor/post-form.php');
...
if (isset($_GET['code'])) {
    ...
    header('Location: https://eduportal.aki-dev.online/instructor/post-form.php?class='.$_SESSION["storeCode"]);
    exit;
}
