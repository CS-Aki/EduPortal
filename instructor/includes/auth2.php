...
$client->setRedirectUri('https://eduportal.aki-dev.online/instructor/material.php');
...
if (isset($_GET['code'])) {
    ...
    header('location: https://eduportal.aki-dev.online.com/instructor/material.php?class='.$_SESSION["codeTemp"].'&post='.$_SESSION["postTemp"]);
    exit;
}
