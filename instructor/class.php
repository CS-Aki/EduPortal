...
if(isset($_GET["error"])){
    header("location: http://localhost/instructor/class.php?class=" . $_SESSION["storeCode"]);
}
...
<body>
 ...
 <div class="mt-2">
                        ...
                        <?php 
                                    if(isset($post[0]["content_type"])){
                                        for($i = 0 ; $i < count($post); $i++){
                                            if($post[$i]["content_type"] == "Seatwork"){
                                                $months = array("January", "February", "March", "April", "May", "June", "July", "August", "September", "October", "November", "December");
                                                $year = $post[$i]["month"][0] . "" . $post[$i]["month"][1] . $post[$i]["month"][2] . "" . $post[$i]["month"][3];
                                                $month = $months[(int)($post[$i]["month"][5] . $post[$i]["month"][6]) - 1];
                                                $day = $post[$i]["month"][8] . "" . $post[$i]["month"][9];
                    ...
                    <div class="mt-2">
                        ...
                        <?php 
                                    if(isset($post[0]["content_type"])){
                                        for($i = 0 ; $i < count($post); $i++){
                                            if($post[$i]["content_type"] == "Assignment"){
                                                $months = array("January", "February", "March", "April", "May", "June", "July", "August", "September", "October", "November", "December");
                                                $year = $post[$i]["month"][0] . "" . $post[$i]["month"][1] . $post[$i]["month"][2] . "" . $post[$i]["month"][3];
                                                $month = $months[(int)($post[$i]["month"][5] . $post[$i]["month"][6]) - 1];
                                                $day = $post[$i]["month"][8] . "" . $post[$i]["month"][9];
                                ...
                                <div class="modal-body">
                                        <div class="container-fluid mb-3 d-flex justify-content-between align-items-center">
                                            <div class="d-flex justify-content-center align-items-center">
                                                <div>
                                                    <i class='bi bi-gear-fill fs-1 green1 title p-0 m-0'></i>
                                                </div>
                                                <div class="lh-sm">
                                        ...
                                        <div class="container-fluid">
                                            ...
                                            <div class="col-lg-6">
                                                ...
                                                <div class="col-lg-6">
                                                    <label class="form-label black3 mb-0">Seatwork Weighted Grade</label>
                                                    <select class="form-select shadow-elevation-light-3 black3" name="daySched" id="seatwork_wg" required>
                                                        <option value="0">0</option>
                                                        <option value="5">5</option>
                                                        <option value="10">10</option>
                                                        <option value="15">15</option>
                                                ...
                                                <div class="col-lg-12 mb-2">
                                                    <label class="form-label black3 mb-0">Assignment Weighted Grade</label>
                                                    <select class="form-select shadow-elevation-light-3 black3" name="daySched" id="assignment_wg" required>
                                                        <option value="0">0</option>
                                                        <option value="5">5</option>
                                                        <option value="10">10</option>
                                                        <option value="15">15</option>
