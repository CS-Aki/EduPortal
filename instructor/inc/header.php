...
<div class="col-lg-2 shadow-sm" id="sidebar-menu">
    <ul>
        <a href="instructor-dashboard.php" class="fs-3 h-font"><li class="mt-3"><i class="bi bi-house-door-fill ms-3 me-2 greenicon"></i>Home</li></a>
                    ...
                    <div id="flush-collapseTwo" class="accordion-collapse collapse" data-bs-parent="#accordionFlushExample2">
                        <?php 
                            for($i = 0 ; $i < count($classList); $i++){
                                ...
                                ?>
                                    <a href='class.php?class=<?php echo md5($classList[$i]['class_code']);?>' class='fs-5 text-truncate d-inline-block' style='max-width: 100%;'>
                                <?php
