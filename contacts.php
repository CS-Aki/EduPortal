                    ...
                    <div style="width: 90%;">
                        <div class="mb-3">
                            ...
                            <div class="d-flex align-items-center mb-2">
                                ...
                                <p class="black3 lh-sm fs-5 mb-0">
                                    <a href="facebook.com/eduportal" class="black3">facebook.com/eduportal</a>               
                                </p>
                            </div>
                            <div class="d-flex align-items-center mb-2">
                                <i class="bi bi-twitter-x green1 fs-3 p-0 m-0 me-2 "></i>
                                <p class="black3 lh-sm fs-5 mb-0">
                                    <a href="x.com/eduportal" class="black3">x.com/eduportal</a>               
                                </p>
                            </div>
                            <div class="d-flex align-items-center mb-2">
                                <i class="bi bi-instagram green1 fs-3 p-0 m-0 me-2 "></i>
                                <p class="black3 lh-sm fs-5 mb-0">
                                    <a href="instagram.com/eduportal" class="black3">instagram.com/eduportal</a>               
                                </p>
                            </div>
