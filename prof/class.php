                    ...
                    <div class="row d-flex px-2 py-1">
                        <div class="col-lg-9">
                            <p class="lh-base fw-semibold green2 fs-5">
                                Class Schedule: <span id="classSched" class="fw-semibold black3"><?php echo $details[0]["class_code"]; ?></span></br>
                                Professor: <span id="classInstructor" class="fw-semibold black3"><?php echo $details[0]["class_schedule"]; ?></span></br>
                        ...
                        <div class="col-lg-3 ms-auto">
                            <div class="container-fluid bg-body-tertiary py-2 rounded-4">
                                <p class="fw-semibold green2 fs-5 lh-sm">Attendance <br>
                                    ...
                                    <span class="fs-6 fw-semibold black3">September 20, 2024</span>
                                </p>
                                    ...
                                    if(isset($post[0]["content_type"])){
                                        for($i = 0 ; $i < count($post); $i++){
                                            if($post[$i]["content_type"] == "Material"){
                                                ?>
                                                    <a href='material.php?class=<?php echo md5($details[0]["class_code"]); ?>&post=<?php echo md5($post[$i]['title']); ?>'>             
                                                <?php
